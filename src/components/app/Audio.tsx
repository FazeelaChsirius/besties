    ...
    const startCall = async () => {
        try {
            ...
            notify.open({
                ...
                onClose: stopAudio,
                actions: [
                    <button key="end" className="bg-rose-400 px-6 py-2 rounded font-medium text-white hover:bg-rose-500">End call</button>
                ]
            })
            ...
            notify.open({
                ...
                actions: [
                    <button 
                        ...
                        key="accept" 
                        className=" mr-3 bg-green-400 px-6 py-2 rounded font-medium text-white hover:bg-green-500"
                    >
                        Accept
                    </button>,
                    <button 
                        ...
                        key="reject" 
                        className="bg-rose-400 px-6 py-2 rounded font-medium text-white hover:bg-rose-500"
                    >
                        Reject
                    </button>
                ]
            ...
            <div className="grid grid-cols-2 gap-4">
                <Card title={session.fullname}>
                    ...
                    <div className="flex flex-col items-center">
                        <img 
                            src={session.image || "/images/girl.png"} 
                            alt="avt"
                ...
                <Card title={liveActiveSession.fullname}>
                    <div className="flex flex-col items-center">
                        <img 
                            src={liveActiveSession.image || "/images/girl.png"} 
                            alt="avt"
                            className="w-40 h-40 rounded-full object-cover"
                        />
                    </div>
